window.onload = function() {
    ...
    var buttons = [ { x: 30, y: 240, width: 150, height: 50, text: "Новая игра"},
                    { x: 30, y: 300, width: 150, height: 50, text: "Показать ходы"},
                    { x: 30, y: 360, width: 150, height: 50, text: "Вкл. ИИ"}];
    ...
    function render() {
        ...
        drawCenterText("Счет:", 30, level.y+40, 150);
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Romanov - Match game", 10, 30);
        ...
        for (var i=0; i<buttons.length; i++) {
            if (pos.x >= buttons[i].x && pos.x < buttons[i].x+buttons[i].width &&
                ...
                if (i == 0) {
                    ...
                    // Show Moves
                    showmoves = !showmoves;
                    buttons[i].text = (showmoves?"Убрать":"Показать") + " ходы";
                } else if (i == 2) {
                    // AI Bot
                    aibot = !aibot;
                    buttons[i].text = (aibot?"Выкл.":"Вкл.") + " ИИ";
                }
            }
        }
    }
